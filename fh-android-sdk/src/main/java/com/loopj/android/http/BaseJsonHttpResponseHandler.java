 ...
 * class, response will be then handled to implementation of abstract methods {@link #onSuccess(int, org.apache.http.Header[], String, Object)} or
 * {@link #onFailure(int, org.apache.http.Header[], Throwable, String, Object)}, depending of response HTTP status line (result http code)
 * 
 * @param <JSON_TYPE> the Java type of the header
 */
