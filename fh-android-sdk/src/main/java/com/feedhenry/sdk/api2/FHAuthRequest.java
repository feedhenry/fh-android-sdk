...
public class FHAuthRequest extends FHRemote {
    ...
    private final FHAuthSession mAuthSession;
     ...
     */
    public FHAuthRequest(Context context, FHAuthSession pAuthSession) {
        super(context);
     ...
     */
    public void setPresentingActivity(Activity pActivity) {
